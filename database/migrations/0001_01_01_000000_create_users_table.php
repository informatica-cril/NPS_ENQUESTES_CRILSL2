...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->string('username')->nullable()->unique(); // <--- agregado para login con username
            $table->string('email')->nullable()->unique(); // <--- ahora nullable
            ...
            $table->rememberToken();
            $table->timestamps();
            $table->softDeletes(); // si tu seeder espera deleted_at
        });
